...
public class SMImplVersion1 implements SM {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      Record found = null;
      SMImplVersion1.OID rec1_oid = null;
      SMImplVersion1.OID rec2_oid = null;
      SMImplVersion1.OID rec3_oid = null;
      ...
      // store & fetch
      rec1_oid = (SMImplVersion1.OID) sm.store(rec1);
      ...
      // store & delete
      try {
        rec2_oid = (SMImplVersion1.OID) sm.store(rec2);
      ...
      try {
        rec3_oid = (SMImplVersion1.OID) sm.update(rec1_oid, rec3);
